...
This is an MDX file ([see source](https://github.com/flowershow/demo/blob/main/other/mdx-file.mdx)) where you can use Flowrshow components (e.g. `List`) or add your own JSX blocks.
